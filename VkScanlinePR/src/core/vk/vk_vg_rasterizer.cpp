...
void VulkanVGRasterizerBase::initVulkan()
{
	...
	VkResult res = _vulkanDevice->createLogicalDevice(_enabledFeatures, enabledDeviceExtensions, deviceCreatepNextChain);
	/*if (res != VK_SUCCESS) {
...
void VulkanVGRasterizerBase::getEnabledFeatures()
{
}
...
VkPipelineShaderStageCreateInfo VulkanVGRasterizerBase::loadShader(std::string fileName, VkShaderStageFlagBits stage)
{
	VkPipelineShaderStageCreateInfo shaderStage = {};
	shaderStage.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
	shaderStage.stage = stage;
	shaderStage.module = vk::util::loadShader(fileName.c_str(), _device);
